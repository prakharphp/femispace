...
class ExerciseActivity(models.Model):
    ...
    date = models.DateField()
    is_actual = models.BooleanField(default=False)
    master = models.ForeignKey(ExerciseActivityMaster, on_delete=models.CASCADE, blank=True, null=True)
...
class DrinkingWaterActivity(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    date = models.DateField()
    master = models.ForeignKey(DrinkingActivityMaster, on_delete=models.CASCADE, blank=True, null=True)
    is_actual = models.BooleanField(default=False)
...
class SugarIntakeActivity(models.Model):
    ...
    date = models.DateField()
    is_actual = models.BooleanField(default=False)
    master = models.ForeignKey(SugarIntakeActivityMaster, on_delete=models.CASCADE, blank=True, null=True)
...
class MeditationActivity(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    master = models.ForeignKey(MeditationMaster, on_delete=models.CASCADE, blank=True, null=True)
    date = models.DateField()
    meditation = None
